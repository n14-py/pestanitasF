...
const MOCK_PRODUCTS = [
    ...
    { _id: 'p3', name: 'Adhesivo Ultra Rápido 1s (5ml)', price: 45000, description: 'Adhesivo de secado ultra rápido (1 segundo) con retención de hasta 8 semanas. Bajo nivel de vapores.', sku: 'ADH-ULT-003', category: { name: 'Adhesivos' }, photos: ['/images/p3.jpg'], isForSale: true, isForRent: false },
